...
import { AlertCircle, Database, XCircle } from 'lucide-react';
...
export function DataTest() {
  ...
  useEffect(() => {
    setError('This component has been deprecated. All data must be loaded from G: drive through the main application.');
  }, []);
      ...
      <div className="text-center">
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-4">
          <div className="flex items-center justify-center space-x-2 text-sm text-gray-600">
            ...
            <span>Data Source: G: Drive Only</span>
            <XCircle className="w-4 h-4 text-red-500" />
            <span>Local Data: Forbidden</span>
          </div>
        </div>
