          ...
          <div>
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div className="flex items-center gap-2 px-3 py-1.5 bg-slate-100 rounded-xl">
                ...
                <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Tools</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              >
                ...
                <div className="text-left">
                  <span className="font-bold text-slate-800 group-hover:text-blue-700 transition-colors block">Create Proforma Invoice</span>
                  <span className="text-xs text-slate-400 mt-0.5 block">Generate invoice from SO data</span>
                </div>
                <ArrowUpRight className="w-4 h-4 text-slate-300 group-hover:text-blue-500 ml-auto transition-colors" />
              </button>
              ...
              >
                ...
                <div className="text-left">
                  <span className="font-bold text-slate-800 group-hover:text-orange-700 transition-colors block">Create Purchase Requisition</span>
                  <span className="text-xs text-slate-400 mt-0.5 block">Request materials for production</span>
                </div>
                <ArrowUpRight className="w-4 h-4 text-slate-300 group-hover:text-orange-500 ml-auto transition-colors" />
              </button>

              {/* Create Logistics Paperwork */}
              <button 
                onClick={() => onNavigate('logistics')}
                className="group relative flex items-center gap-4 p-5 rounded-2xl bg-white border-2 border-slate-100 hover:border-emerald-400 hover:shadow-lg hover:shadow-emerald-500/10 transition-all duration-300 hover:-translate-y-0.5"
              >
                <div className="w-12 h-12 flex-shrink-0 flex items-center justify-center bg-gradient-to-br from-emerald-500 to-teal-600 rounded-xl shadow-lg shadow-emerald-500/20 group-hover:shadow-emerald-500/40 transition-shadow">
                  <Truck className="w-6 h-6 text-white" />
                </div>
                <div className="text-left">
                  <span className="font-bold text-slate-800 group-hover:text-emerald-700 transition-colors block">Create Logistics Paperwork</span>
                  <span className="text-xs text-slate-400 mt-0.5 block">All shipping docs for ready orders</span>
                </div>
                <ArrowUpRight className="w-4 h-4 text-slate-300 group-hover:text-emerald-500 ml-auto transition-colors" />
              </button>
            </div>
          </div>
