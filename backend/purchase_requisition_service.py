...
if IS_RENDER:
    print("[PR] OK Running on Render - Will use Google Drive API for data")
elif IS_CLOUD_RUN:
    print("[PR] OK Running on Cloud Run - Will use Google Drive API for data")
else:
    if IS_LOCAL:
        print("[PR] OK Running locally - Will use local drive path if available, else Drive API")
    else:
        print("[PR] WARN Local run but no local drive path - Will use Google Drive API")
